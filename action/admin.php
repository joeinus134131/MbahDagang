...
<body>
    ...
    <table class="table table-striped table-hove">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='edit.php?id_barang=$row[id_barang]' class='btn btn-primary'>Edit</a> | <a href='delete.php?id_barang=$row[id_barang]' class='btn btn-primary'>Delete</a></td></tr>";
        }
        ?>
    </table>
